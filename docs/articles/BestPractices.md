...
2. It can make the tests more complicated. Multiple assertions usually mean you're actually performing multiple tests, which makes the test more complicated and potentially harder to understand.
